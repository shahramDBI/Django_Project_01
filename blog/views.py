...
from django.views.generic.detail import SingleObjectMixin  # محتوای اتچ شده به یو آر ال را استخراج میکند
...
class CommentPost(SingleObjectMixin, FormView):
    ...
    def form_valid(self, form):
        comment = form.save(commit=False)  # در دیتابیس ذخیره نمیشود
